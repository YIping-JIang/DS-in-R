...
knitr::kable(mpg_1, digits = 2, align = 'c', col.names = c("class", "City MPG", "Highway MPG"), booktabs = T, caption = "Average City and Highway MPG by Car Class", longtable = T)
```
...
kable(fi, digits = 2, align = 'c', format = 'latex', booktabs = T, longtable = T, caption = "Top 3 MPG Performing Cars: 1999, 2008") %>%
  kable_styling() %>%
